                    ...
                    <tr>
                      <td>
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                          <tr >
                            <td colspan="3">
                              <h2>Bonjour {{ $validate_mails->user->name }}</h2>
                            </td> 
                          </tr>
                          <tr>
                            <td colspan="3">
                              <p>Votre demande à été {{ $validate_mails->text_statut }} merci de bien vouloir vous rendre a la direction generale pour recuperer une autorisation d'absence sans se document l'accord n'est pas valide.</p>
                            </td> 
                          </tr>
                          <tr>
                            <td>
                            ...
                            <td class="espace">
                             {{ Str::upper($validate_mails->types->label) }}
                            </td>
                          </tr>
                          <tr>
                            <td>
                            ...
                            <td class="espace">
                              {{ Str::upper(str_pad($validate_mails->type_demandes_id, 3, '0', STR_PAD_LEFT).str_pad($validate_mails->direction_id, 2, '0', STR_PAD_LEFT).$validate_mails->id) }}
                            </td>
                          </tr>
                          <tr>
                            <td>
                            ...
                            <td class="espace">
                              {{ Str::upper($validate_mails->direction->label) }}
                            </td>
                          </tr>
                          <tr>
                            <td>
                            ...
                            <td class="espace">
                              {{ Str::upper($validate_mails->created_at) }}
                            </td>
                          </tr>
                          <tr>
                            <td>
                            ...
                            <td class="espace">
                              {{ Str::upper($validate_mails->text_statut) }}
                            </td>
                          </tr>
                          <tr>
                            <td>
                            ...
                            <td class="espace">
                              <ul style="padding-left: 0px">
                                @if($validate_mails->motif_permi != null)
                                  <li>{{ Str::upper($validate_mails->motif_permi) }}</li>
                                  @else
                                  @foreach ($validate_mails->objets as $mail)
                                      <li>{{ Str::upper($mail->classes->label) }}</li>
                                  @endforeach
                                @endif
                                @foreach ($validate_mails->objets as $mail)
                                    <li>{{ Str::upper($mail->label) }}</li>
                                @endforeach
                              </ul>
                            </td>
                          </tr>
