                    ...
                    <tr>
                      <td>
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                          <tr >
                            <td colspan="3">
                              <h2>Bonjour {{ $users->name}}</h2>
                            </td> 
                          </tr>
                          <tr>
                            <td colspan="3">
                              <p>Vous ne pouvez faire cette demande car vous n'avez que {{ $users->differenceEnMois }} mois d'ancienneté, si votre demande est urgente et que vous souhaitez faire cette demande merci de bien vouloir rediger une demande manuscrite et la remettre a la direction generale pour avoir une autorisation.</p>
                            </td> 
                          </tr>
                          <tr>
                            <td>
