...
@section('content')
    <form id="objet_demande_sousobjet" method="POST">
...
@section('modalbutton')
    ...
    <button type="button" data-lien="{{route('objet_demande_sousobjet')}}" data-form="objet_demande_sousobjet" class="btn btn-primary envoie_demande" style="border-radius: 20px; background-color: #21301a; color: #ffffff;">Valider</button>
@stop