...
@section('modalbutton')
    ...
    <button type="button" data-lien="{{route('objet_demande_g.update', [$id])}}" data-form="objet_demande_g" class="btn btn-primary Updatedemande" style="border-radius: 20px; background-color: #21301a; color: #ffffff;">Valider</button>
@stop