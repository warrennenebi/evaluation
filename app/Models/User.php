...
{    
    ...
    function organes(){
        return $this->hasMany(organe_validateur::class);
    }
    
    // Configuration de l'enregistrement des logs
    protected static $logAttributes = ['name', 'email'];
    protected static $logName = 'users'; // Nom personnalisé pour le log
    ...
    public function getActivitylogOptions(): LogOptions
    {
        return LogOptions::defaults()
            ->logOnly(['name', 'email']) // Les champs à suivre
            ->logOnlyDirty() // Ne log que les changements
