...
(function(h) {
    ...
    function Ca(a) {
        ...
        if (a) {
            ...
            !a.sEmptyTable && (d && "Aucune donnée disponible dans le Tableau" === b.sEmptyTable) && F(a, a, "sZeroRecords", "sEmptyTable");
    ...
    function K(a, b, c, d) {
        ...
        else if (b = n.ext, b = b.sErrMode || b.errMode, a && r(a, null, "error", [a, d, c]), "alert" == b) console.log(c);
        else {
    ...
    h.extend(n.ext.classes, {
        ...
        sFilterInput: "form-control-data form-control-sm",
        sLengthSelect: "form-control-data",
